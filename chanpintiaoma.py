...
class Xinzeng(unittest.TestCase):
    ...
    def test_03xinzeng(self):  # 新增产品条码重复
        ...
        self.sy.find_element(By.NAME, "pro_name").send_keys("户县户太八号")
        self.sy.find_element(By.NAME, "cpbh").send_keys("222")
        self.sy.find_element(By.NAME, "cptxm").send_keys("54321")
        self.sy.find_element(By.XPATH,"/html/body/section/section/section/div/div/section/div/form/div[8]/div/div/div[2]/iframe").send_keys("紫色的，很完美哦")
        try:
            self.sy.find_element(By.XPATH,"/html/body/section/section/section/div/div/section/div/form/div[9]/div/button").click()
            time.sleep(3)
            newyuqi = self.sy.find_element(By.CLASS_NAME, "layui-layer-content").text
            self.assertEqual(newyuqi, "产品条码有重复!", msg="产品条码错误")
